...
void vf_callback(camera_handle_t handle, camera_buffer_t* buf, void* arg)
{
    ...
    HelloVideoCameraApp* app = (HelloVideoCameraApp*) arg;
...
void HelloVideoCameraApp::encoding_thread()
{
...
void HelloVideoCameraApp::update_fps(camera_buffer_t* buf)
{
...
void HelloVideoCameraApp::print_fps(camera_buffer_t* buf)
{
...
void HelloVideoCameraApp::onWindowAttached(unsigned long handle, const QString &group, const QString &id)
{
...
void HelloVideoCameraApp::onWindowDetached(unsigned long handle, const QString &group, const QString &id)
{
